 ...
 */
if (!function_exists("isubmission_convert_date")) {
	function isubmission_convert_date($date, $format = 'ISO') {
...
*/
if (!function_exists("isubmission_truncate")) {
	function isubmission_truncate($string, $max = 20, $replacement = '') {
...
*/
if (!function_exists("isubmission_stopXSS")) {
	function isubmission_stopXSS($text) {
		if (!is_array($text)) {
 ...
 */
if (!function_exists("isubmission_is_secure")) {
	function isubmission_is_secure() {
		if (
 ...
 * @return string
 */
if (!function_exists("isubmission_rewrite_string")) {
	function isubmission_rewrite_string($string = "") {
 ...
 */
if (!function_exists("isubmission_get_locale")) {
	function isubmission_get_locale() {
		$isubmission_locale_wp = get_locale();
		if ($isubmission_locale_wp == 'fr_FR')
			setlocale(LC_TIME, "fr_FR.utf8", "fra");
		else {
			setlocale(LC_TIME, "$isubmission_locale_wp.utf8", "fra");
		}
	}
}

// random string
function isubmission_random1( $length = 8 ) {
...
function isubmission_random2( $length = 10 ) {
...
function isubmission_random3( $length = 16 ) {
	...
	return isubmission_random4( $length );
}

function isubmission_random4( $length = 16 ) {
